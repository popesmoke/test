...
function PlanCard({ plan, onBuy, checkoutBusy, stripeEnabled, shoppexUrl, shoppexEnabled }) {
        ...
        <div className="pricing-card__actions">
          ...
          {stripeEnabled ? (
            ...
            <button
              ...
              className={`btn ${shoppexUrl ? "btn--ghost" : "btn--primary"} pricing-card__buy`}
...
export function PurchasePage() {
  ...
  const shoppexEnabled = Boolean(pricing?.shoppex_enabled);

  const shoppexStoreUrl = pricing?.shoppex_store_url || "";
          ...
          <div className="pricing-grid">
            ...
            {pricing.personal.map((plan) => (
              ...
              <PlanCard
                ...
                shoppexEnabled={shoppexEnabled}
                shoppexUrl={shoppexPlanUrls.get(plan.id) || shoppexStoreUrl}
      ...
      <div className="pricing-cta">
        ...
        <div className="pricing-payment-grid">
          ...
          <PaymentMethodList
            ...
            methods={shoppexPayments}

          />

          <PaymentMethodList

            title="Discord ticket only"

            methods={discordTicketPayments}
